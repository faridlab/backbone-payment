//! ModeOfPayment DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new ModeOfPayment
///
...
pub struct CreateModeOfPaymentDto {
...
/// Request DTO for full update of a ModeOfPayment
///
...
#[cfg_attr(feature = "validation", derive(Validate))]
#[serde(rename_all = "camelCase")]
pub struct UpdateModeOfPaymentDto {
    #[cfg_attr(feature = "validation", validate(length(max = 40)))]
    #[cfg_attr(feature = "openapi", schema(example = "example"))]
    pub code: String,
    #[cfg_attr(feature = "validation", validate(length(max = 120)))]
...
/// Request DTO for partial update of a ModeOfPayment
///
...
#[cfg_attr(feature = "validation", derive(Validate))]
#[serde(rename_all = "camelCase")]
pub struct PatchModeOfPaymentDto {
    #[cfg_attr(feature = "validation", validate(length(max = 40)))]
    #[cfg_attr(feature = "openapi", schema(example = "example"))]
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "mode_type")]
...
/// Response DTO for ModeOfPayment entity
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ModeOfPaymentResponseDto {
...
/// Paginated list response for ModeOfPayment entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ModeOfPaymentListResponseDto {
    /// List of items
    pub items: Vec<ModeOfPaymentResponseDto>,
...
impl ModeOfPaymentListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<ModeOfPaymentResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ModeOfPaymentSummaryDto {
    pub id: Uuid,
    pub code: String,
    pub name: String,
    pub mode_type: ModeType,
...
impl From<ModeOfPayment> for ModeOfPaymentResponseDto {
    fn from(entity: ModeOfPayment) -> Self {
        Self {
            id: entity.id,
            code: entity.code,
            name: entity.name,
...
impl From<ModeOfPayment> for ModeOfPaymentSummaryDto {
    fn from(entity: ModeOfPayment) -> Self {
...
impl From<CreateModeOfPaymentDto> for ModeOfPayment {
    fn from(dto: CreateModeOfPaymentDto) -> Self {
        Self {
            id: Uuid::new_v4(),
            code: dto.code,
            name: dto.name,
...
impl backbone_core::FromCreateDto<CreateModeOfPaymentDto> for ModeOfPayment {
    fn from_create_dto(dto: CreateModeOfPaymentDto) -> backbone_core::ServiceResult<Self> {
        Ok(ModeOfPayment::from(dto))
    }
}

impl backbone_core::ApplyUpdateDto<UpdateModeOfPaymentDto> for ModeOfPayment {
    fn apply_update(mut self, dto: UpdateModeOfPaymentDto) -> backbone_core::ServiceResult<Self> {
        self.code = dto.code;
        self.name = dto.name;
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to ModeOfPayment here.
