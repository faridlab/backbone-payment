//! Specifications for DunningRun aggregate
//!
...
// Each predicate implements `Specification<DunningRun>` and can be combined
...
//
// pub struct ActiveDunningRunSpec;
// impl Specification<DunningRun> for ActiveDunningRunSpec {
//     fn is_satisfied_by(&self, e: &DunningRun) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
