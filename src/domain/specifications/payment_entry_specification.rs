//! Specifications for PaymentEntry aggregate
//!
...
// Each predicate implements `Specification<PaymentEntry>` and can be combined
...
//
// pub struct ActivePaymentEntrySpec;
// impl Specification<PaymentEntry> for ActivePaymentEntrySpec {
//     fn is_satisfied_by(&self, e: &PaymentEntry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
