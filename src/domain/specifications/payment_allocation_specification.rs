//! Specifications for PaymentAllocation aggregate
//!
...
// Each predicate implements `Specification<PaymentAllocation>` and can be combined
...
//
// pub struct ActivePaymentAllocationSpec;
// impl Specification<PaymentAllocation> for ActivePaymentAllocationSpec {
//     fn is_satisfied_by(&self, e: &PaymentAllocation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
