//! Specifications for AgingSnapshot aggregate
//!
...
// Each predicate implements `Specification<AgingSnapshot>` and can be combined
...
//
// pub struct ActiveAgingSnapshotSpec;
// impl Specification<AgingSnapshot> for ActiveAgingSnapshotSpec {
//     fn is_satisfied_by(&self, e: &AgingSnapshot) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
