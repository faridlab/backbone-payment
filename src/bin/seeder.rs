//! Database seeder binary for module: payment
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin payment-seeder
//! Or via CLI: backbone seed run --module payment
//!
...
use backbone_payment::seeders::Seeder;
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: payment");
    println!();
