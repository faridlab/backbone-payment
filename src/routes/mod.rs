...
/// Create stateless routes for the Payment module.
///
...
///
/// ```ignore
/// let module = PaymentModule::builder().with_database(pool).build()?;
...
pub fn get_routes(module: &crate::PaymentModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Payment module.
///
...
pub fn create_combined_routes(module: &crate::PaymentModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Payment module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::PaymentModule) -> Router<AppState> {
    Router::new()
